...
## Does it work yet?
Nope. As of writing, I have only written a button parser and the start of an events system. However, I have determined it to be entirely doable, so I am going to do it! I have a life (a crazy one at that), so no promises on a delivery date. Feel free to offer your help!
